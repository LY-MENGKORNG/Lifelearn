...
import ThemeController from '../../commons/ThemeController'
	...
	return (
		<>
								...
								<DropdownMenuTrigger asChild>
									<SidebarMenuButton
										...
										<div className='grid flex-1 text-left text-sm leading-tight'>
											...
											<p className='truncate text-xs'>{sidebar.user.email}</p>
										</div>
			...
			<SidebarInset>
				...
				<div className='flex flex-1 flex-col gap-4 px-4 py-6 pt-0'>
					{children}
				</div>
			</SidebarInset>
		</>
